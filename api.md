...
{% hint style="info" %}
There is a limit of 60 requests per minute with the API, to get higher limits please apply for an API Key by following this guide: [api-keys](https://docs.snapshot.box/tools/api/api-keys "mention")
{% endhint %}
...
![](https://545909647-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F-MG4Ulnnabb2Xz3Lei9_%2Fuploads%2Fgit-blob-38f3f642d0c0e238930ca21823575e3f5e15737c%2Fimage.png?alt=media)
